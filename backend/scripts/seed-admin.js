...
const ADMIN_EMAIL=process.env.ADMIN_EMAIL||'admin@rcelbosque.local';const ADMIN_PASSWORD=process.env.ADMIN_PASSWORD||'admin123';const ADMIN_NAME=process.env.ADMIN_NAME||'Administrador';
